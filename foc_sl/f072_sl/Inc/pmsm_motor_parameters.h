...
#define RS                     0.40 /* Stator resistance , ohm*/
#define LS                     0.000320 /* Stator inductance, H
...
#define NOMINAL_CURRENT         18180
#define MOTOR_MAX_SPEED_RPM     3500 /*!< Maximum rated speed  */
#define MOTOR_VOLTAGE_CONSTANT  13.6 /*!< Volts RMS ph-ph /kRPM */
#define ID_DEMAG                -18180 /*!< Demagnetization current */
