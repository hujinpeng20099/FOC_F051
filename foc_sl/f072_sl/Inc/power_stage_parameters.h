...
#define HW_DEAD_TIME_NS               650 /*!< Dead-time inserted
                                                         by HW if low side signals
                                                         are not used */

/*********** Bus voltage sensing section ****************/
#define VBUS_PARTITIONING_FACTOR      0.0449 /*!< It expresses how
...
#define AMPLIFICATION_GAIN            18.31

/*** Noise parameters ***/
#define TNOISE_NS                     2000
#define TRISE_NS                      3000
#define MAX_TNTR_NS TRISE_NS

/************ Temperature sensing section ***************/
/* V[V]=V0+dV/dT[V/Celsius]*(T-T0)[Celsius]*/
#define V0_V                          1.056 /*!< in Volts */
#define T0_C                          25 /*!< in Celsius degrees */
#define dV_dT                         0.026 /*!< V/Celsius degrees */
