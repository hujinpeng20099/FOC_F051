...
#define MIN_APPLICATION_SPEED_RPM       800 /*!< rpm, mechanical,
                                                           absolute value */
...
#define PID_TORQUE_KP_DEFAULT         5500 
#define PID_TORQUE_KI_DEFAULT        	3000
#define PID_TORQUE_KD_DEFAULT         100
#define PID_FLUX_KP_DEFAULT           5500
...
#define PID_SPEED_KP_DEFAULT          1550/(SPEED_UNIT/10) /* Workbench compute the gain for 01Hz unit*/
#define PID_SPEED_KI_DEFAULT          55/(SPEED_UNIT/10) /* Workbench compute the gain for 01Hz unit*/
...
#define PHASE2_FINAL_CURRENT           18000
/* Phase 3 */
#define PHASE3_DURATION                350 /*milliseconds */
#define PHASE3_FINAL_SPEED_UNIT         (350*SPEED_UNIT/_RPM)
#define PHASE3_FINAL_CURRENT           18000
/* Phase 4 */
#define PHASE4_DURATION                1150 /*milliseconds */
#define PHASE4_FINAL_SPEED_UNIT         (1200*SPEED_UNIT/_RPM)
#define PHASE4_FINAL_CURRENT           18000
/* Phase 5 */
#define PHASE5_DURATION                0 /* milliseconds */
#define PHASE5_FINAL_SPEED_UNIT         (1500*SPEED_UNIT/_RPM)
#define PHASE5_FINAL_CURRENT           18000
...
#define TRANSITION_DURATION            150  /* Switch over duration, ms */
/******************************   BUS VOLTAGE Motor 1  **********************/
